...
module.exports = async () => {
  try {
    // Filter products where is_deal is true
    ...
    return {
      content: [
        { type: 'text', text: `Found ${promotions.length} active promotional offers with discounts up to 50%.` }
      ],
      structuredContent: promotions
    };
  } catch (error) {
    return {
      content: [
